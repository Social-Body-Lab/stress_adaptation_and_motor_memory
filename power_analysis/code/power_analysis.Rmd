...
#plot power analyse for neighbourhood effect on motor short-term memory
...
* Roma camp and Scampia standardised scores on short-term motor memory test: _M_ = -0.5 (_SD_ = 1)
* Pozzuoli standardised scores on short-term motor memory test: _M_ = 0.25 (_SD_ = 1)
